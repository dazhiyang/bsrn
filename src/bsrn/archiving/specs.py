...
Defines the rigid ASCII fixed-width formatting rules, missing values, 
mandatory fields, default values, and descriptive labels for all 
BSRN Logical Records.
...
"""
bsrn.archiving.stations

Centralized metadata for BSRN stations. 
Used to auto-populate Logical Records (LR0001, LR0002, LR0004) 
with correct coordinates, elevations, official station numbers, 
scientist contacts, and site topologies.

BSRN 站点的集中元数据。
用于自动填充逻辑记录（LR0001、LR0002、LR0004），
包括正确的坐标、海拔、官方站点编号、科学家联系方式和站点地形。
"""
...
"""
bsrn.archiving.mappings

Standardized categorical mappings for BSRN Logical Records.
Includes topographies, surfaces, and radiation quantities.
"""
